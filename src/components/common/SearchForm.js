...
/**
 *
 * SearchForm is rendered in the ProductList component with {search} passed in as a prop.
 *
 * This component renders the search form and calls the `search` function prop that is passed in to the parent component (ProductList) to do the searching.
 *
...
function SearchForm({ search }) {
  ...
  function handleSubmit(event) {
    ...
    // 'search' function accepts trimmed piece of state 'searchInput' as a prop. It makes an API call and reloads products depending on what is passed in as the searchInput.
